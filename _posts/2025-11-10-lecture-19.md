...
bibliography: /assets/bibliography/2025-11-10-lecture-19.bib
---
...
| LSTM              | Uses gates to manage information flow and handle long-term dependencies |
| Gradient Clipping | Prevents gradient explosion during training                             |
| Truncated BPTT    | Limits gradient flow length to improve stability                        |
| Embeddings        | Dense learned representations that capture semantic word relationships  |
| Application       | NLP, speech recognition, machine translation, time series prediction    |
